...
import com.org.news.htmltextview.HtmlImageGetter;
...
public class ReadPager extends SherlockFragmentActivity {
	...
	public  class MyAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			return ContentFragment.newInstance(mCurrentTitle,descrition,link);
		}
	}
	...
	public static class ContentFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
	       ...
	       // LinearLayout adlayout =(LinearLayout)v.findViewById(R.id.AdLinearLayout); 
